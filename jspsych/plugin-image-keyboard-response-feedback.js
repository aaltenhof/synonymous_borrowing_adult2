var jsPsychImageKeyboardResponseFeedback = (function (jspsych) {
  'use strict';

  var version = "2.0.0";

  const info = {
    name: "image-keyboard-response-feedback",
    version,
    parameters: {
  ...
  class ImageKeyboardResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      if (trial.render_on_canvas) {
        ...
        html += "<br><br>​"
        html += '<label for="response">Response:</label> <input type="text" id="response" name = "response" style="width: 400px;" >';
